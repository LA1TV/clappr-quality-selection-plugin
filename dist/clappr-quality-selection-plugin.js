(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["ClapprQualitySelectionPlugin"] = factory(require("Clappr"));
	else
		root["ClapprQualitySelectionPlugin"] = factory(root["Clappr"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';Object.defineProperty(exports,'__esModule',{value:true});var _createClass=(function(){function defineProperties(target,props){for(var i=0;i < props.length;i++) {var descriptor=props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if('value' in descriptor)descriptor.writable = true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};})();var _get=function get(_x,_x2,_x3){var _again=true;_function: while(_again) {var object=_x,property=_x2,receiver=_x3;_again = false;if(object === null)object = Function.prototype;var desc=Object.getOwnPropertyDescriptor(object,property);if(desc === undefined){var parent=Object.getPrototypeOf(object);if(parent === null){return undefined;}else {_x = parent;_x2 = property;_x3 = receiver;_again = true;desc = parent = undefined;continue _function;}}else if('value' in desc){return desc.value;}else {var getter=desc.get;if(getter === undefined){return undefined;}return getter.call(receiver);}}};function _interopRequireDefault(obj){return obj && obj.__esModule?obj:{'default':obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError('Cannot call a class as a function');}}function _inherits(subClass,superClass){if(typeof superClass !== 'function' && superClass !== null){throw new TypeError('Super expression must either be null or a function, not ' + typeof superClass);}subClass.prototype = Object.create(superClass && superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__ = superClass;}var _clappr=__webpack_require__(1);var _jQuery=__webpack_require__(2);var _jQuery2=_interopRequireDefault(_jQuery);__webpack_require__(3);var QualitySelectionPlugin=(function(_UICorePlugin){_inherits(QualitySelectionPlugin,_UICorePlugin);_createClass(QualitySelectionPlugin,[{key:'name',get:function get(){return 'quality-selection-plugin';}},{key:'attributes',get:function get(){return {'class':this.name};}}]);function QualitySelectionPlugin(core){_classCallCheck(this,QualitySelectionPlugin);_get(Object.getPrototypeOf(QualitySelectionPlugin.prototype),'constructor',this).call(this,core);this._qualities = [];var chosen={text:"360p"};this._qualities = [{text:"720p"},chosen,{text:"240p"}];this._chosenQuality = null;this._chosenQuality = chosen;this._renderedQualities = [];this._overChosenQuality = false;this._overList = false;this._renderPlugin();}_createClass(QualitySelectionPlugin,[{key:'bindEvents',value:function bindEvents(){this.listenTo(this.core.mediaControl,_clappr.Events.MEDIACONTROL_RENDERED,this._onMediaControlRendered);this.listenTo(this.core.mediaControl,_clappr.Events.MEDIACONTROL_CONTAINERCHANGED,this._onMediaControlContainerChanged);}},{key:'_bindContainerEvents',value:function _bindContainerEvents(){if(this._oldContainer){this.stopListening(this._oldContainer,_clappr.Events.CONTAINER_TIMEUPDATE,this._onTimeUpdate);this.stopListening(this._oldContainer,_clappr.Events.CONTAINER_MEDIACONTROL_SHOW,this._onMediaControlShow);}this._oldContainer = this.core.mediaControl.container;this.listenTo(this.core.mediaControl.container,_clappr.Events.CONTAINER_TIMEUPDATE,this._onTimeUpdate);this.listenTo(this.core.mediaControl.container,_clappr.Events.CONTAINER_MEDIACONTROL_SHOW,this._onMediaControlShow);}},{key:'_getOptions',value:function _getOptions(){if(!("qualitySelectionPlugin" in this.core.options)){throw "'qualitySelectionPlugin' property missing from options object.";}return this.core.options.qualitySelectionPlugin;} // array of {name}
	// will appear in the same order
	},{key:'setQualities',value:function setQualities(qualities){ // TODO
	this._renderPlugin();} // quality should be reference to a quality object passed to setQualities
	},{key:'setChosenQuality',value:function setChosenQuality(quality){ // TODO
	this._renderPlugin();}},{key:'_onMediaControlRendered',value:function _onMediaControlRendered(){this._appendElToMediaControl();}},{key:'_onMediaControlContainerChanged',value:function _onMediaControlContainerChanged(){this._bindContainerEvents();}},{key:'_appendElToMediaControl',value:function _appendElToMediaControl(){this.$el.insertAfter(this.core.mediaControl.$el.find(".media-control-layer .media-control-right-panel .drawer-container[data-volume]"));}},{key:'_renderPlugin',value:function _renderPlugin(){var _this=this;var $el=(0,_jQuery2['default'])(this.el);if(this._qualities.length === 0){$el.hide();}else {$el.show();if(this._haveQualitiesChanged()){this._$qualities.forEach(function($a){$a.remove();});this._$qualities = [];if(this._qualities.length <= 1){this._$noQualitiesMsg.show();}else {this._$noQualitiesMsg.hide();}this._qualities.forEach(function(quality){var $quality=(0,_jQuery2['default'])("<li />").addClass("quality-row").attr("data-clickable","1").text(quality.text);$quality.click(function(){_this._overList = false;_this._renderPlugin();});_this._$qualities.push($quality);_this._$qualitiesContainer.append($quality);});}for(var i=0;i < this._qualities.length;i++) {var quality=this._qualities[i];this._$qualities[i][quality === this._chosenQuality?"hide":"show"]();}this._$chosenQuality.text("Quality: " + this._chosenQuality.text);var visible=this._overChosenQuality || this._overList;this._$qualitiesContainer.attr("data-visible",visible?"1":"0");}}},{key:'_haveQualitiesChanged',value:function _haveQualitiesChanged(){if(this._qualities.length !== this._renderedQualities.length){return true;}for(var i=0;i < this._qualities.length;i++) {if(this._qualities[i] !== this._renderedQualities[i]){return true;}}return false;}},{key:'render',value:function render(){var _this2=this;var $el=(0,_jQuery2['default'])(this.el);$el.hide();this._$qualitiesContainer = (0,_jQuery2['default'])("<ul />").addClass("qualities-container");this._$noQualitiesMsg = (0,_jQuery2['default'])("<li />").addClass("quality-row no-qualities-msg").text("No other qualities available.");this._$qualitiesContainer.append(this._$noQualitiesMsg);this._$qualities = [];this._$chosenQuality = (0,_jQuery2['default'])("<div />").addClass("chosen-quality");this._$chosenQuality.hover(function(){_this2._overChosenQuality = true;_this2._renderPlugin();},function(){_this2._overChosenQuality = false;_this2._renderPlugin();});$el.hover(function(){_this2._overList = true;_this2._renderPlugin();},function(){_this2._overList = false;_this2._renderPlugin();});$el.append(this._$qualitiesContainer);$el.append(this._$chosenQuality);this._appendElToMediaControl();return this;}},{key:'destroy',value:function destroy(){ // TODO
	}}]);return QualitySelectionPlugin;})(_clappr.UICorePlugin);exports['default'] = QualitySelectionPlugin;module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/sass-loader/index.js?includePaths[]=C:/Users/Thoma/Documents/GitHub/clappr-quality-selection-plugin/node_modules/compass-mixins/lib!./style.sass", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/sass-loader/index.js?includePaths[]=C:/Users/Thoma/Documents/GitHub/clappr-quality-selection-plugin/node_modules/compass-mixins/lib!./style.sass");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".quality-selection-plugin {\n  position: relative !important;\n  display: inline-block !important;\n  float: right !important;\n  height: 32px !important;\n  margin: 0 6px !important; }\n  .quality-selection-plugin .qualities-container {\n    position: absolute;\n    bottom: 100%;\n    right: 0;\n    display: none;\n    list-style-type: none;\n    background-color: #aaaaaa;\n    border-color: #000000;\n    border-width: 1px;\n    border-style: solid;\n    -webkit-box-shadow: 3px 3px 5px 0px rgba(50, 50, 50, 0.75);\n    -moz-box-shadow: 3px 3px 5px 0px rgba(50, 50, 50, 0.75);\n    box-shadow: 3px 3px 5px 0px rgba(50, 50, 50, 0.75); }\n    .quality-selection-plugin .qualities-container[data-visible=\"1\"] {\n      display: inline-block; }\n    .quality-selection-plugin .qualities-container .quality-row {\n      padding: 1px 8px;\n      font-size: 13px;\n      white-space: nowrap;\n      cursor: default; }\n      .quality-selection-plugin .qualities-container .quality-row.no-qualities-msg {\n        font-style: italic; }\n      .quality-selection-plugin .qualities-container .quality-row[data-clickable] {\n        cursor: pointer; }\n        .quality-selection-plugin .qualities-container .quality-row[data-clickable]:hover {\n          background-color: #ffffff; }\n  .quality-selection-plugin .chosen-quality {\n    display: inline-block;\n    vertical-align: bottom;\n    color: #ffffff;\n    font-size: 12px;\n    cursor: pointer; }\n", ""]);
